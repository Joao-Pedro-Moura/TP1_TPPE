...
public class ValorImposto {
	...
	@Test
	public void testeValorFaixaUm() throws DescricaoEmBrancoException, ValorRendimentoInvalidoException, ValorDeducaoInvalidoException, NomeEmBrancoException {
		...
		assertEquals(0f, simulador.getValorImposto(), 0.1f);
	}
